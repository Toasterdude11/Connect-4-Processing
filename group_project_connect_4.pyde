...
def setup():
    ...
    background(255)
    noStroke()
    global selectorX, selectorY, circleSize, player, Left, Right, Down, Up, One, Two, endTurn
...
#When the space bar is pressed, the players turn is over and the piece stays in the spot that it is currently in, becoming a 'played' piece
#def endTurn():
    #player = played


def keyPressed():
    global selectorX, selectorY, circleSize, player1, Left, Right, Down, Up, One, Two, endTurn
